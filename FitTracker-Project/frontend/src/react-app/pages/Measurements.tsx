...
export default function Measurements() {
    ...
    const weightChange = (latestMeasurement && initialMeasurement && latestMeasurement.weight_kg !== null && initialMeasurement.weight_kg !== null) ? (latestMeasurement.weight_kg - initialMeasurement.weight_kg).toFixed(1) : '0.0';
